    ...
    sections: {
      ...
      words: {
        ...
        defs: [
          ...
          ['Start / Sit', 'Start means play him this week; sit means leave him on your bench. The analyst calls these from how many games each player has.'],
          ...
          ['Games in hand', 'How many games your whole team plays this week versus your opponent. More games usually means more points.'],
          ...
          ['The read', 'One answer from the analyst about one week: every player, every call, every sentence.'],
          ...
          ['Telestrator', 'The pen TV analysts use to draw circles and arrows on a paused game. This page is one, for an AI analyst.'],
          ...
          ['WebMCP', 'The same idea inside a web page: the page tells an AI in your browser which actions it offers. This page offers seven.'],
        ],
      },
      connect: {
