  ...
  about: {
    ...
    sections: {
      ...
      words: {
        ...
        paras: ['Three vocabularies meet on this page: fantasy hockey, the TV broadcast it borrows from, and the technology underneath.'],
        defs: [
          ['Fantasy hockey', 'A game where you pick real NHL players for your own team and score points when they play well. Players only score on days their real team plays.'],
          ['Lineup', 'The players on your fantasy team this week, and where each one sits: playing, on the bench, or injured.'],
          ...
          ['Stream', 'Picking up a player for a short stretch because his team plays a lot that week, then letting him go.'],
          ['Back-to-back', 'Two games on consecutive days. Tired legs, and often a backup goalie. Marked b2b on the rink.'],
          ['Games in hand', 'How many games your whole team plays this week versus your opponent. More games usually means more points.'],
          ['IR', 'Injured reserve: players who are hurt and not playing.'],
          ['Ice quality', 'The patch under each player. Fresh, glossy ice means a good week for him; chewed-up ice means a light week or a back-to-back.'],
          ...
          ['MCP', 'Model Context Protocol: a standard way for an AI assistant to use outside tools. The analyst speaks it.'],
